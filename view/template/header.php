                    ...
                    <div class="modal-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="signup-username" placeholder="6 - 16 alpha,num and underline">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="signup-password" class="col-sm-4 control-label">Password:</label>
                                <div class="col-sm-5">
                                    <input type="password" class="form-control" id="signup-password" placeholder="at least 8 ,without space">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="password" class="form-control" id="signup-re-password" placeholder="re-type">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="signup-school" placeholder="alpha">
                                </div>
                            </div>
        ...
        <nav class="navbar navbar-default navbar-fixed-top header">
          <div class="container">
            ...
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="/index.php">WHUTOJ</a>
            </div>

            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="navbar-collapse-left">
                <ul class="nav navbar-nav">
                    <li><a href="/index.php?controller=problemlist">Problem</a></li>
                    ...
                    <li><a href="/index.php?controller=rank">Ranklist</a></li>
              </ul>
                ...
                <?php
                    if(isset($_SESSION['username']))
                    {
                        ...
                        echo '        <li><a href="/index.php?controller=viewprofile&username='. $_SESSION['username'] .'">View Profile</a></li>';
                        echo '    </ul>';
                        echo '</li>';
                    }
                    else
